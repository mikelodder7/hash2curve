...
fn main() {
    ...
    let dst = DomainSeparationTag::new(b"BLS12381G1_XMD:SHA-256_SSWU_RO_", Some(b"BENCHMARKS"), None, None).unwrap();
    ...
    for i in 0..blocks {
        ...
        print!("Doing bls12-381-g1-sswu-hash-to-curve-xmd-sha256 for {}s on message size {}: ", timeout_secs, block_byte_sizes[i]);
        stdout().flush().unwrap();
